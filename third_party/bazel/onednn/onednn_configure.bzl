...
_ONEDNN_BUILD_ARGS_DEFAULT = "-j"
_ONEDNN_BUILD_ARGS="BUILD_WITH_ONEDNN_ARGS"
...
def _onednn_impl(repository_ctx):
    ...
    if with_mkldnn:
        ...
        onednn_build_args = get_host_environ(repository_ctx, _ONEDNN_BUILD_ARGS, _ONEDNN_BUILD_ARGS_DEFAULT)
        if with_aarch64:
        ...
        repository_ctx.template("onednn.BUILD", Label("//bazel/onednn:onednn.BUILD.tpl"), {
            ...
            "%{CMAKE_BUILD_ARGS}": "\"{}\"".format(onednn_build_args),
        })
